...
public class UnitCarrier extends IUnit
{
	...
	{
		if (unit.getClass() == UnitBomber.class) return true;
		if (unit.getClass() == UnitFighter.class) return true;
		if (unit.getClass() == UnitHelicopter.class) return true;
		return false;
	}
