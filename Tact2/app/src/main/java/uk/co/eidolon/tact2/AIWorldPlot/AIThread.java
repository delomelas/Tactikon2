...
import uk.co.eidolon.tact2.AIWorldPlot.AIInfo.Route;
import uk.co.eidolon.tact2.AIWorldPlot.AIInfo.Task;
import uk.co.eidolon.tact2.AIWorldPlot.AIInfo.TaskType;
...
public class AIThread extends IAIThread
{
	...
	public float varAttackProbRequired = 0.25f;
	...
	void TickAI(TactikonState state)
	{
		...
		for (IUnit unit : mUnitList)
		{
			...
			if (DoConsideredTasks(unit, state) == true) return;
		}*/
