...
public class GLWaterMap extends GLContext
{
	private final String VertexShader = 
	        ...
	        "   vTexCoord1 = vec2(aTexCoord1.x + sin(uTime*25.0 + aTexCoord1.x *5.0) / 20.0, aTexCoord1.y + cos(uTime*25.0 + aTexCoord1.y*5.0 ) / 20.0);					\n" +
	        "   vHeight = aHeight;							\n" +
	        "}                         						\n";
	...
	GLWaterMap(TactikonState state, Texture texture1, Texture texture2, int tileType, float rangeMin, float rangeMax, RangeFunctor functor)
	{
        ...
        muTime = GLES20.glGetUniformLocation(mShaderProgram, "uTime");
